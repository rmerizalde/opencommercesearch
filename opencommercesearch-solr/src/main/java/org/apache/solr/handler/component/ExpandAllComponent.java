...
/**
  ...
  *
  * NOTE: This implementation fully expands the groups, including the collapsed document
  * <p/>
...
public class ExpandAllComponent extends SearchComponent implements PluginInfoInitialized, SolrCoreAware {
  ...
  private boolean doExpandAll(ResponseBuilder rb) {
    return  rb.req.getParams().getBool("expandall",false);
  }
  ...
  public String getDescription() {
    return "Expand All Component";
  }

  @Override
  public String getSource() {
    return "https://raw.github.com/rmerizalde/opencommercesearch/master/opencommercesearch-solr/src/main/java/org/apache/solr/handler/component/ExpandAllComponent.java";
  }
